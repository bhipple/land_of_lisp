...
(load "../web_server/web_server.lisp")
(load "../svg_html/svg.lisp")
...
(defparameter *die-colors* '((255 63 3) (63 63 255)))
...
;;                            Graphics Rendering
;; ============================================================================
; Draw a die "the hard way," rendering it out of SVG polygons!
...
; Draw 1 tile, with 0-3 dice on it
